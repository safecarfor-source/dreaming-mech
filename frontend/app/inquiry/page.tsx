              ...
              >
                ...
                {process.env.NEXT_PUBLIC_KAKAO_OPENCHAT_URL && (
                  <a
                    ...
                    className="flex flex-col items-center justify-center gap-0.5 w-full bg-[#FEE500] text-gray-900
                      px-6 py-4 rounded-xl font-bold hover:bg-[#FDD835] transition-all mb-4"
                  >
                    <span className="flex items-center gap-2 text-base">
                      <span>💬</span>
                      <span>카카오 오픈채팅 참여하기</span>
                    </span>
                    <span className="text-xs font-normal text-gray-600">진행상황 안내</span>
                  </a>
                )}
