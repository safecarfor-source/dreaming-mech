  ...
  return (
    <ErpLayout>
      <div className="max-w-7xl mx-auto">
        {/* 페이지 제목 */}
        <h1 className="text-2xl font-bold text-gray-900 mb-6">ERP 매출 분석</h1>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="px-3 py-1.5 rounded-lg border border-gray-200 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#7C4DFF]/30"
              />
              ...
              <button
                ...
                className="px-4 py-1.5 bg-[#7C4DFF] text-white rounded-lg text-sm font-medium hover:bg-[#6B3DE8] transition-colors"
              >
                조회
              </button>
            </div>
