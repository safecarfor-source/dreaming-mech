              ...
              <div className="flex flex-col h-full">
                <nav className="flex-1 px-5 py-6 space-y-1">
                  <Link
                    ...
                    className="flex items-center gap-3 px-4 py-3.5 text-[var(--text-body)] text-text-secondary hover:text-brand-500 hover:bg-brand-50 rounded-xl font-medium transition-colors"
                  >
                    서비스
                  </Link>
                  <Link
                ...
                {/* 하단 사장님 로그인 */}
                <div className="px-5 pb-8 pt-4 border-t border-[var(--border-light)]">
                  <Link
                    href="/owner/login"
                    onClick={() => setMobileMenuOpen(false)}
                    className="block w-full text-center px-4 py-3.5 bg-brand-500 text-white rounded-xl font-semibold text-[var(--text-body)]
                      transition-colors duration-[var(--duration-normal)] hover:bg-brand-600
