    ...
    <div className="p-4 bg-purple-50 rounded-xl space-y-3">
      ...
      <div className="relative">
        <textarea
          ...
          rows={2}
          maxLength={100}
          className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm resize-none focus:outline-none focus:border-purple-500 text-gray-900"
        />
      ...
      <div className="flex gap-2 justify-end">
        ...
        <button
          ...
          className="px-4 py-2 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-400 text-white text-sm rounded-lg font-medium transition-colors flex items-center gap-1"
        >
          {isSubmitting ? (
            <>
