  ...
  if (submitted) {
    return (
      <div className="p-6 text-center space-y-4">
        ...
        <button
          onClick={onClose}
          className="mt-4 px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-medium transition-colors"
        >
          확인
        </button>
      </div>
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          placeholder="홍길동"
          className="w-full px-3 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-purple-500 text-gray-900"
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full px-3 py-2.5 border border-gray-200 rounded-lg text-sm resize-none focus:outline-none focus:border-purple-500 text-gray-900"
        />
      </div>
      ...
      <button
        ...
        className="w-full py-3 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-400 text-white rounded-xl font-bold transition-colors flex items-center justify-center gap-2"
      >
        {isSubmitting ? (
          <>
